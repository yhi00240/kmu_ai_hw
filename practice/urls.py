...
urlpatterns = [
    ...
    url(r'^(?P<practice_name>.+)/hw/$', views.HW.as_view(), name='hw'),
    url(r'^(?P<practice_name>.+)/hw/draw$', views.HW.draw, name='hw_draw'),
    url(r'^(?P<practice_name>.+)/hw/draw_result$', views.HW.draw_result, name='hw_draw_result'),
]
